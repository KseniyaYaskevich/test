...
;// CONCATENATED MODULE: ./src/scripts/modules/profileTabs.js
var profileTabs = function profileTabs() {
...
var carousels = function carousels() {
  ...
  var owlLeft = $('.carousels__direction--left');
  owlLeft.owlCarousel({
    rtl: true,
    loop: true,
    margin: 24,
...
;// CONCATENATED MODULE: ./src/scripts/modules/featuresSwiper.js


var featuresSwiper = function featuresSwiper() {
  var arrowPrev = document.querySelector('.swiper-features__button--prev');
  var arrowNext = document.querySelector('.swiper-features__button--next');
  document.addEventListener('DOMContentLoaded', function () {
    var main = new Splide('.swiper-features', {
      type: 'fade',
      rewind: true,
      pagination: false,
      arrows: false
    });
    var thumbnails = new Splide('.swiper-trumb', {
      type: 'fade',
      rewind: true,
      pagination: false,
      arrows: false
    });
    var thumbnails2 = new Splide('.swiper-trumb2', {
      type: 'fade',
      rewind: true,
      pagination: false,
      arrows: false
